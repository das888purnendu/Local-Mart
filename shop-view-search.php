...
<body>
    ...
    <main class="page shopping-cart-page">
      ...
      $row = mysqli_fetch_assoc($data);
			...
			$l1="' shop-review.php?sl=$sl'";
                ...
                <div class="content">
                   <h2>Here is your search Result : For " <?php echo $search; ?> "</h2><br>
                    <div class="items">
                      
                      
                       <?php

								$data=mysqli_query($conn,"SELECT * FROM `all_item` WHERE `all_item`.`shop_code` = '".$sl."' and (`item` LIKE '%".$search."%') ORDER BY `all_item`.`price` ASC");
  ...
  echo "<h3> Sorry ! No item Found of Name '".$search."'</h3>";
}
                        ?>
