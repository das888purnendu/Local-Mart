<?php 
include("conn.php");
$shop=mysqli_real_escape_string($conn,$_GET['search']);
...
<body>
        ...
        <section class="clean-block clean-blog-list dark">
            <div class="container">
                ...
                <div style="background-color:#ffffff;">
                    <div>
                       <form method="post">
                        <div class="float-right"><input name="search" type="search" placeholder="Type Shop Name / Code" style="height:32px;">
                ...
                <div class="block-content">
                   <h2>Here is your search Result : For " <?php echo $shop; ?> "</h2><br>
	...
	$query="SELECT * FROM `all_shop` where (`shop_name` LIKE '%".$shop."%') or (`sl` LIKE '%".$shop."%')";
						...
						else
{
  ...
  echo "<h3> Sorry ! No Shop Found of Name '".$shop."'</h3>";
}
